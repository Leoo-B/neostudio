...
export const TOOLS: ToolDef[] = [
...

  {
    ...
    category: "games",
    name: "Tebak Gambar",
    desc: "Guess the picture — menebak sebanyak-banyaknya dalam 90 detik",
    fields: [],
    resultKind: "json",
    renderKind: "tebakGambar",
    ...P("data"),
    imageField: "img",
    answerField: "jawaban",
...

  {
    ...
    category: "games",
    name: "Family 100",
    desc: "Family 100 quiz — tebak semua jawaban dengan poin hingga 100",
    fields: [],
    resultKind: "json",
    renderKind: "family100",
    ...P("data"),
    questionField: "soal",
    answersField: "jawaban",
  },
